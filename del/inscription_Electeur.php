...
<form action="../controller/electeurController.php" method="POST">
                      ...
                      <div class="md-form">
                        <input type="text" name="NumElecteur"  class="form-control" required>
                    ...
                    <div class="md-form">
                        <input type="text" name="CNIElecteur"  class="form-control" required>
                      ...
                      <div class="text-center mt-4">
                        <button type="submit" name="valider_inscription" class="btn btn-success">Valider</button>
